...
const RightPanel: React.FC<Props> = ({
    ...
    const menuItems = [
        ...
        { label: menuLabel?.story || '剧情', action: onOpenStory, color: 'primary' as const, changeKeys: ['剧情', '剧情规划'] },
        ...(enablePlanningPanel && enableHeroinePlan ? [{ label: menuLabel?.plan || '红颜规划', action: onOpenHeroinePlan, color: 'primary' as const, changeKeys: ['女主剧情规划'] }] : []),
