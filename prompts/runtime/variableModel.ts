...
export const 构建变量模型职责提示词 = (options?: { survivalNeedsEnabled?: boolean }): string => {
    ...
    return 按功能开关过滤提示词内容(
        格式化多段文本([
            ...
            '12.1 普通手机、钱包、银行卡、钥匙、笔记本电脑、普通衣物默认只作为生活背景，不得写入 `角色.物品列表` 或装备栏；只有剧情证据、任务道具、工作配发、加密数据、损坏状态、可交付物、当前要操作/交付的对象或明确金额现金，才作为可追踪物品落地。钱包、银行卡和电子支付账号不承载余额，明确金额继续统一写入 `角色.金钱.baseAmount`。',
