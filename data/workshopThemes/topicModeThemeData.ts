...
const 现代单一货币提示 = '经济结算统一使用现代单一货币“元”；收入、消费、报酬和奖励都写入角色.金钱.baseAmount。题材特殊资源只能作为物品、任务条件或剧情筹码，不作为额外钱包字段。';
const 现代单一货币换算提示 = '单一现代货币：单位=元；无多层换算、无汇率换算、无自定义货币体系。';
...
export const 题材模式配置表: Record<题材模式类型, 题材模式配置> = {
    ...
    仙侠: {
        ...
        worldDefaults: {
            ...
            worldExtraRequirement: '经济结算统一使用现代单一货币“元”，所有收入、消费和报酬写入角色.金钱.baseAmount；灵石、丹药、符箓、法器和能力贡献只能作为物品、任务条件或剧情筹码。'
        },
        worldSizeLabel: '修真版图',
    ...
    西方奇幻: {
        ...
        worldDefaults: {
            ...
            worldExtraRequirement: '本局为西方奇幻：经济结算统一使用现代单一货币“元”并写入角色.金钱.baseAmount；魔晶、法术卷轴、附魔材料、公会声望、贵族担保和教会赎券只能作为物品、任务条件或剧情筹码。不要使用宗门、灵石、丹药、飞剑或古风银票作为默认经济核心。'
        },
        worldSizeLabel: '王国版图',
    ...
    现代都市: {
        ...
        promptBoundary: '现代都市开局只生成现实社会结构；兼容变量 `玩家组织` 只能承载公司、学校、社区、家庭、媒体、项目组、店铺、合作团队等现实社会结构。',
        promptLines: [
            '本存档以现代都市为核心题材：现实城市制度、职业压力、家庭关系、交通、手机、互联网、人民币和法律后果必须成立。',
            '不要默认前现代统治结构、隐秘超常组织、古风贡献体系或旧题材黑话；若出现低玄异常，也必须嵌入现代社会后果。'
        ]
    },
    末日丧尸: {
        value: '末日丧尸',
        ...
        promptLines: [
            ...
            '不要写古代王朝、宗门或古风江湖交易；社会秩序应表现为现代设施残骸、幸存者营地、军方残部、掠夺团、临时市场和隔离区。',
    ...
    无限流: {
        ...
        label: '无限流',
        shortLabel: '无限',
        hint: '主神空间、恐怖片轮回、支线剧情、强化兑换与团队生存。',
        group: 'infinite',
        worldDefaults: {
            worldName: '主神空间',
            worldSize: '无尽位面',
        ...
        manualRealmPrompt: '能力体系：新人、正式轮回者、资深者、解开一阶基因锁、队长级轮回者；成长来自兑换规划、支线剧情、兑换强化、基因锁、恐怖片情报与团队分工。',
        promptBoundary: '无限流开局不得生成古代门派、宗门、师门、同门、山门、藏经阁、古风组织贡献体系或营地信用；兼容变量 `玩家组织` 只能承载轮回小队、队伍房间、主神空间、临时同盟或团战阵营。',
        promptLines: [
            '本存档以无限流/主神空间为核心题材：主神发布任务，轮回者进入恐怖片或跨题材任务世界，完成主线、支线、隐藏目标后获得元、兑换权限或支线剧情凭证。',
            '外部市场、强化、修复和兑换入口必须称为主神商城；团队内部兑换页可称为团队商城。资金统一写入角色.金钱.baseAmount，D/C/B/A/S级支线剧情只作为稀缺高级门槛或剧情凭证，不要混用银钱、灵石、宗门贡献或现实工资作为核心经济。',
            '能力成长可包含血统、技能、科技装备、魔法物品、武学、精神力、基因锁和团队分工，但每次强化都要有元成本、支线剧情门槛、适配风险、任务压力和副作用。',
